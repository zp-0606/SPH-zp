  ...
  <div class="cart">
    ...
    <div class="cart-tool">
      <div class="select-all">
        <input class="chooseAll" type="checkbox" :checked="isAllCheck&&cartInfoList.length>0" @click="undateAllCartIsChecked"/>
        <span>全选</span>
      </div>
      <div class="option">
...
export default {
  ...
  computed: {
    ...
    totalPrice() {
      ...
      checkedCart.forEach(element=>{num += element.skuPrice * element.skuNum})
      return num;
    },
    isAllCheck() {
